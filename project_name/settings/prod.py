...
class Settings(common.Settings):
    ...
    # Environment vars are string type
    # To use boolean vars, we need to use the following function to convert string to boolean
    is_true = lambda param, default=None: default if param is None else str(True) == param

    if is_true(environ.get('USE_SSLIFY')):
        MIDDLEWARE_CLASSES = ('sslify.middleware.SSLifyMiddleware', ) + common.Settings.MIDDLEWARE_CLASSES

    ########## DEBUG CONFIGURATION
    # See: https://docs.djangoproject.com/en/dev/ref/settings/#debug
    DEBUG = is_true(environ.get('DJANGO_DEBUG'), common.Settings.DEBUG)
    ########## END DEBUG CONFIGURATION

    ########## EMAIL CONFIGURATION
    # See: https://docs.djangoproject.com/en/dev/ref/settings/#email-backend
    if is_true(environ.get('USE_CELERY_EMAIL')):
        EMAIL_BACKEND = 'djcelery_email.backends.CeleryEmailBackend'

    # See: https://docs.djangoproject.com/en/dev/ref/settings/#email-host
    EMAIL_HOST = environ.get('EMAIL_HOST', common.Settings.EMAIL_HOST)

    # See: https://docs.djangoproject.com/en/dev/ref/settings/#email-host-password
    EMAIL_HOST_PASSWORD = environ.get('EMAIL_HOST_PASSWORD', common.Settings.EMAIL_HOST_PASSWORD)

    # See: https://docs.djangoproject.com/en/dev/ref/settings/#email-host-user
    EMAIL_HOST_USER = environ.get('EMAIL_HOST_USER', common.Settings.EMAIL_HOST_USER)

    # See: https://docs.djangoproject.com/en/dev/ref/settings/#email-port
    EMAIL_PORT = int(environ.get('EMAIL_PORT', common.Settings.EMAIL_PORT))
    ...
    SECRET_KEY = environ.get('SECRET_KEY', common.Settings.SECRET_KEY)
    ...
    ########## MICS
    # Robots.txt
    ALLOW_SEARCH_ENGINE_INDEXING = is_true(environ.get('ALLOW_SEARCH_ENGINE_INDEXING'), True)

    #Disable static urls
    EXPOSE_STATIC_URLS = is_true(environ.get('EXPOSE_STATIC_URLS'), False)
    ########## END MISC
